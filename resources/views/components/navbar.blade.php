<!-- Left Sidebar Navigation -->
    ...
    <a href="{{ route('welcome') }}" title="Constanza Bitthoff – Home">
        <img
            src="{{ asset('photos/coni-logo-7.png') }}"
        ...
        >
            ...
            <nav class="space-y-6 text-lg">
                ...
                <a href="#performances" class="block uppercase text-gray-400 hover:text-black transition">Performances <span class="text-sm">+</span></a>
   ...
   <!-- YouTube – perfectly smooth hover, no bleed -->
    <a href="https://www.youtube.com/@gaunkocheese"
       target="_blank"
       class="block group">
    ...
    <a href="https://www.facebook.com/constanza.bitthoff"
       target="_blank"
       class="block group">
    ...
    <a href="https://www.instagram.com/bitthoff_constanza/"
       target="_blank"
       class="block group">
        <svg class="w-7 h-7 fill-none stroke-current text-gray-800 
